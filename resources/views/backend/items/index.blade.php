                                ...
                                @foreach ($list as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdesign">
                                            ...
                                            @can('Edit Items')
                                                <a href="{{ route('backend.items.edit',$item->id) }}" class="bluebutton" ><i class="fa fa-edit"></i></a>&nbsp;
                                            @endcan

                                            @can('Delete Items')
                                                <a title="Delete" href="#" data-action="{{route('backend.items.destroy',$item->id)}}" class="redbutton deleteRecord"><i class="fa fa-trash"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                @endforeach
