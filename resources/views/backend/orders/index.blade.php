...
{{--                                        <td class="tdesign">{{ $order->address }}</td>--}}
                                        ...
                                        <td class="tdesign">
                                            ...
                                            @can('Assign Task Orders')
                                                <a href="{{ route('backend.orders.assignTask',$order->id) }}" class="purplebutton" ><i class="fa fa-user-plus"></i></a>&nbsp;
                                            @endcan

                                            @can('Show Orders')
                                                <a href="{{ route('backend.orders.show',$order->id) }}" class="pinkbutton" ><i class="fa fa-eye"></i></a>&nbsp;
                                            @endcan

                                            @can('Change Status Orders')
                                                <a href="{{ route('backend.orders.changeStatus',$order) }}" class="greenbutton" ><i class="fa fa-comment"></i></a>&nbsp;
                                            @endcan

                                            @can('Delete Orders')
                                                <a title="Delete" href="#" data-action="{{route('backend.orders.destroy',$order->id)}}" class="redbutton deleteRecord"><i class="fa fa-trash"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                @endforeach
